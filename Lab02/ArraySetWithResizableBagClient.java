 ...
 * @version 12/28/2016
 */
public class ArraySetWithResizableBagClient
{
    public static void main(String[] args)
    {
        ...
        SetInterface<String> aSet = new ArraySetWithResizableArrayBag<>(contentsOfBag.length);
        ...
        SetInterface<String> set2 = new ArraySetWithResizableArrayBag<>(contentsOfBag);
...
} // end ArraySetWithResizableBagClient